...
def train_model(model, dataloader, epochs=20, lr=0.001, plot_results=True):
    ...
    if plot_results:
        ...
        plt.legend()
        plt.savefig("./plots/train_roc_curve.png", dpi=300)
...
def render_confusion_matrix(cm, class_names, normalize=False, cm_save_path="./plots/test_CM.png"):
...
def evaluate_model_with_attention(model, dataloader, roc_save_path="./plots/test_roc_curve.png"):
    """
...
def plot_attention_distribution(attention_scores, true_labels, save_path="./plots/attention_distribution.png"):
    """
...
save_path = "./models/trained_model_focal_llh_new.pth"
...
plot_attention_distribution(test_attention_scores, true_test_labels, save_path="./plots/attention_distribution_focal_llh_new.png")
